...
?>
  ...
  <main>
    <div class="hero">
      <h1>ELECTRONICS WORLD<h1>
        <h2>Discover the latest gadgets and cutting-edge technology for all your electronic needs.</h2>
    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Tronics Zone.<br>
            #15, RM Nagar Bengaluru.
          </address>
            <div class="phone">
              Telephone:
            ...
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">support@tronicszone.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> TRONICS ZONE &trade;
          </div>

          <div class="developer">
            Developed by Kishorekumar 
          </div>

          <div class="designby">
            Design by Harivarshan
          </div>
